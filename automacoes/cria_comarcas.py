...
comarcas_sc = {
    ...
    "Camboriú": ["Camboriú"],
    "Campo Belo do Sul": ["Campo Belo do Sul", "Cerro Negro", "Capão Alto"], ##################FALTA PARA BAIXO
    "Campo Erê": ["Campo Erê", "Saltinho", "Santa Terezinha do Progresso"],
    "Campos Novos": ["Campos Novos", "Abdon Batista", "Brunópolis", "Monte Carlo", "Vargem"],
    "Canoinhas": ["Canoinhas", "Bela Vista do Toldo", "Major Vieira"],
    "Capinzal": ["Capinzal", "Lacerdópolis", "Ouro"],
    "Capivari de Baixo": ["Capivari de Baixo"],
    "Catanduvas": ["Catanduvas", "Luzerna", "Vargem Bonita"],
    "Chapecó": ["Chapecó", "Cordilheira Alta", "Guatambu"],
    "Concórdia": ["Concórdia", "Alto Bela Vista", "Ipira", "Peritiba", "Piratuba"],
    "Coronel Freitas": ["Coronel Freitas", "Nova Itaberaba"],
    "Correia Pinto": ["Correia Pinto"],
    "Criciúma": ["Criciúma", "Cocal do Sul", "Morro da Fumaça", "Nova Veneza"],
    "Cunha Porã": ["Cunha Porã", "Maravilha", "São Miguel da Boa Vista"],
    "Curitibanos": ["Curitibanos", "Frei Rogério", "Ponte Alta do Norte", "São Cristóvão do Sul"],
    "Descanso": ["Descanso", "Belmonte"],
    "Dionísio Cerqueira": ["Dionísio Cerqueira", "Guarujá do Sul", "Palma Sola", "São José do Cedro"],
    "Florianópolis": ["Florianópolis"],
    "Forquilhinha": ["Forquilhinha"],
    "Fraiburgo": ["Fraiburgo", "Frei Rogério", "Ibiam", "Pinheiro Preto", "Rio das Antas"],
    "Garopaba": ["Garopaba"],
    "Garuva": ["Garuva"],
    "Gaspar": ["Gaspar"],
    "Guaramirim": ["Guaramirim"],
    "Herval d'Oeste": ["Herval d'Oeste", "Erval Velho", "Joaçaba"],
    "Ibirama": ["Ibirama", "Apiúna", "José Boiteux", "Lontras"],
    "Içara": ["Içara", "Balneário Rincão"],
    "Imaruí": ["Imaruí"],
    "Imbituba": ["Imbituba"],
    "Indaial": ["Indaial"],
    ...
    "Itajaí": ["Itajaí", "Navegantes"],
    "Itapema": ["Itapema", "Porto Belo"],
    "Itapiranga": ["Itapiranga", "São João do Oeste", "Tunápolis"],
    "Itapoá": ["Itapoá"],
    "Ituporanga": ["Ituporanga", "Agrolândia", "Atalanta", "Chapadão do Lageado", "Imbuia", "Petrolândia"],
    "Jaguaruna": ["Jaguaruna", "Sangão"],
