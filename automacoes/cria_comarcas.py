...
comarcas_sc = {
    ...
    "Chapecó": ["Chapecó", "Caxambu do Sul", "Cordilheira Alta", "Guatambú", "Paial", "Planalto Alegre"], 
    "Concórdia": ["Concórdia", "Irani", "Alto Bela Vista", "Peritiba", "Presidente Castelo Branco"],
    "Coronel Freitas": ["Coronel Freitas", "União do Oeste", "Jardinópolis"],
    ...
    "Penha": ["Penha"],
    "Pinhalzinho": ["Pinhalzinho", "Nova Erechim", "Saudades", "Nova Itaberaba", "Águas Frias"],
    "Pomerode": ["Pomerode"],
